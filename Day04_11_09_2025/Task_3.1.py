...
def crypted(mess):
    encryptedMessage = ""
    minimum = ord("a") - 1  # Lettre juste avant "a" dans le tableau ASCII
    maximum = ord("z")  # Lettre "z" dans le tableau ASCII
    ...
    # la var "maximum" permet de savoir si on est au dela de "z" dont sa valeur entier ASCII est 122. Même chose pour les majuscules
